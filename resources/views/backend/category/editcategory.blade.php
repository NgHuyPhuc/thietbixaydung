    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-xs-6 col-md-12 col-lg-12">
                <form method="post" enctype="multipart/form-data" action="{{ route('category.postedit',['id'=>$category->id]) }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <img id="avatar" class="thumbnail" width="100%" height="350px"
                                            src="/upload/img/{{$category->image}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-success" type="submit">Sửa danh mục sản phẩm</button>
