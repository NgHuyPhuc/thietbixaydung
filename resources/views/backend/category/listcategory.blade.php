                ...
                <div class="panel-body">
                    <div class="bootstrap-table">
                        <div class="table-responsive">
                            ...
                            <a href="{{route('category.create')}}" class="btn btn-primary">Thêm mới danh mục sản phẩm</a>
                                ...
                                @foreach ($category as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('category.delete',['id' => $item->id])}}" onclick="return confirm('Bạn có chắc chắn muốn danh mục sản phẩm này?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                        </td>
                                    </tr>
                                @endforeach
