                ...
                <div class="panel-body">
                    <div class="bootstrap-table">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" style="margin-top:20px;">
                                ...
                                @foreach ($news as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('new.edit',['id' => $item->id])}}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> Sửa</a>
                                            <a href="{{route('new.delete',['id' => $item->id])}}" onclick="return confirm('Bạn có chắc chắn muốn xóa điều luật này?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <div align='right'>
                                {{$news->links('backend.pagination.pagination')}}
                            </div>
                        </div>
